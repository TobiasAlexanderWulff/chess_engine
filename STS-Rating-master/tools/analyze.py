...
def main():
    ...
    parser.add_argument("--engine", required=True, type=str, help="The engine file (required).")
    parser.add_argument(
        "--hash-mb",
        required=False,
        type=int,
    ...
    parser.add_argument(
        "--engine-option", help='set engine options, e.g. --engine-option "Hash=128,Skill Level=2".'
    )
