...
def bench_position(
    ...
    *,
    ...
    return {
        ...
        "gen_time_main_us": getattr(last, "gen_time_main_us", 0),
        "gen_time_q_us": getattr(last, "gen_time_q_us", 0),
        "gen_time_main_ms": getattr(last, "gen_time_main_ms", 0),
        "gen_time_q_ms": getattr(last, "gen_time_q_ms", 0),
        "q_cap_candidates": getattr(last, "q_cap_candidates", 0),
        "q_king_cap_candidates": getattr(last, "q_king_cap_candidates", 0),
        "q_king_cap_see_pruned": getattr(last, "q_king_cap_see_pruned", 0),
        "q_evasions_generated": getattr(last, "q_evasions_generated", 0),
...
def main() -> None:
    ...
    payload = {
        ...
        "summary": {
            ...
            "total_gen_time_main_us": sum(r.get("gen_time_main_us", 0) for r in results),
            "total_gen_time_q_us": sum(r.get("gen_time_q_us", 0) for r in results),
            ...
            "total_q_cap_candidates": sum(r.get("q_cap_candidates", 0) for r in results),
            "total_q_king_cap_candidates": sum(r.get("q_king_cap_candidates", 0) for r in results),
            "total_q_king_cap_see_pruned": sum(r.get("q_king_cap_see_pruned", 0) for r in results),
            "total_q_evasions_generated": sum(r.get("q_evasions_generated", 0) for r in results),
        },
    }
